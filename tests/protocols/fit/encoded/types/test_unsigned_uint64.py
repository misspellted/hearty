...
class TestUInt64(unittest.TestCase):
  ...
  def test_evaluate_maximum_value_big_endianness(self):
    ...
    valid, value = tested.evaluate(bytes=[0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFE], endianness="big")
    self.assertTrue(valid)
  ...
  def test_evaluate_maximum_value_little_endianness(self):
    ...
    valid, value = tested.evaluate(bytes=[0xFE, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF], endianness="little")
    self.assertTrue(valid)
    self.assertEqual(18446744073709551614, value)
