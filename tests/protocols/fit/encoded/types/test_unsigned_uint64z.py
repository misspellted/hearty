...
class TestUInt64Z(unittest.TestCase):
  ...
  def test_evaluate_minimum_value_big_endianness(self):
    ...
    valid, value = tested.evaluate(bites=[0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01], endianness="big")
  ...
  def test_evaluate_minimum_value_little_endianness(self):
    ...
    valid, value = tested.evaluate(bites=[0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], endianness="little")
    self.assertTrue(valid)
    self.assertEqual(1, value)
